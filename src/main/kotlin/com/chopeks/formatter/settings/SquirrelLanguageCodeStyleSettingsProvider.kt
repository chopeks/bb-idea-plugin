...
class SquirrelLanguageCodeStyleSettingsProvider : LanguageCodeStyleSettingsProvider() {
	override fun getLanguage(): Language {
		return SquirrelLanguage
	}
	...
	override fun customizeSettings(consumer: CodeStyleSettingsCustomizable, settingsType: SettingsType) {
		if (settingsType == SettingsType.SPACING_SETTINGS) {
			...
			consumer.showCustomOption(
				SquirrelCodeStyleSettings::class.java,
...
//            );
	...
	companion object {
		@JvmField
		var standardSpacingSettings: Array<String> = arrayOf( // Before parentheses
			...
			"SPACE_BEFORE_CATCH_PARENTHESES",  // Around operators
			...
			"SPACE_AROUND_UNARY_OPERATOR",  // Before left brace
			...
			"SPACE_BEFORE_CATCH_LBRACE",  // Before keywords

			"SPACE_BEFORE_ELSE_KEYWORD",
			"SPACE_BEFORE_WHILE_KEYWORD",
			"SPACE_BEFORE_CATCH_KEYWORD",  // Within
			...
			"SPACE_WITHIN_CATCH_PARENTHESES",  // Ternary

			"SPACE_BEFORE_QUEST",
			"SPACE_AFTER_QUEST",
			"SPACE_BEFORE_COLON",
			"SPACE_AFTER_COLON",  // Other
		...
		@JvmField
		var customSpacingSettings: Array<String> = arrayOf(
			"SPACE_BEFORE_FUNCTION_EXPRESSION_PARENTHESES",
			"SPACE_BEFORE_FOREACH_PARENTHESES",
			"SPACE_BEFORE_FOREACH_LBRACE",
			"SPACE_WITHIN_FOREACH_PARENTHESES",
		...
		var standardBlankLinesSettings: Array<String> = arrayOf(
			"KEEP_BLANK_LINES_IN_CODE"
		)

		var standardWrappingAndBracesSettings: Array<String> = arrayOf(
			"RIGHT_MARGIN",
			"WRAP_ON_TYPING",
		...
		const val SPACING_CODE_SAMPLE: String = "class Foo {\n" +
				"    tmp = [];\n" +
		...
		const val BLANK_LINES_CODE_SAMPLE: String = "class Foo {\n" +
				"    constructor() {\n" +
				"    }\n" +
				"\n" +
				"\n" +
				...
				"    }\n" +
				"}"
		const val INDENT_CODE_SAMPLE: String = "function test(){\n" +
				"  local i = 4 + ::getTotal() +\n" +
				"  34 - 4 * 32\n" +
				"  ::print(i);\n" +
				"}"
